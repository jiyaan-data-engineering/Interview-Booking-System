      ...
      <head>
        ...
        <style>
          * { margin: 0; padding: 0; box-sizing: border-box; }
          ...
          .candidate-info { margin-top: 15px; text-align: center; }
          .candidate-name { font-size: 28px; font-weight: bold; margin: 10px 0; color: #f1f5f9; }
          .candidate-email { font-size: 13px; color: #cbd5e1; margin-bottom: 10px; }
          .candidate-stats { display: flex; justify-content: center; gap: 20px; margin-top: 12px; font-size: 12px; color: #cbd5e1; }
          .stat-item { display: flex; align-items: center; gap: 5px; }
          .completion-badge { font-size: 20px; font-weight: bold; color: #10b981; }
        ...
        <div class="page">
          ...
          <div class="header">
            ...
            <div class="candidate-info">
              ...
              <div style="font-size: 11px; color: #cbd5e1;">Completion</div>
            </div>
          </div>
          ...
          <div class="metrics-section">
            ...
            <div class="metrics-grid">
              ...
              <div class="metric-card">
                <div class="metric-value">${myInterviews.filter(i => i.status === 'pending').length}</div>
            ...
            <div class="offer-info">
              ...
              <div class="offer-details">
                <div class="offer-detail">
                  ...
                  <div class="offer-value offer-status">✓ ${offerInfo.offerStatus}</div>
                </div>
                <div class="offer-detail">
